<nav class="w-full bg-white border-b dark:bg-slate-900 border-slate-900/10 lg:px-8 dark:border-slate-300/10 lg:mx-0 sticky top-0">
                    ...
                    <div class="flex space-x-4">
                        ...
                        @auth
                            <form class="m-0" action="{{ route('logout') }}" method="POST">
                                @csrf
                                <a onclick="this.closest('form').submit()" href="#" class="lg:px-3 py-2 text-sm font-medium rounded-md hover:text-sky-600 dark:hover:text-white">
                                    Cerrar Sesión
                                </a>
                            </form>                            
                        @endauth
